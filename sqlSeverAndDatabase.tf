resource "azurerm_mssql_server" "sql-planepal-dev-neu-01" {
  name                         = "sql${var.app_name_small_letters}${var.environment}${var.location_abbreviation}00"
...
resource "azurerm_mssql_database" "sqldb-planepal-dev-neu-01" {
  name                = "sqldb${var.app_name_small_letters}${var.environment}${var.location_abbreviation}00"
